...
contract encryptfile {
    ...
    function sendMessage(string memory _message) public {
        string memory prefix ="You are a smart assistant that processes commands related to file encryption. When the user provides an input like encrypt file.txt, your job is to understand the intent and respond with a JSON object containing the detected intent and relevant details.If the user's input is to encrypt a file, extract the filename and return:{intent: encrypt, file: <filename>}.Always ensure the JSON output correctly reflects the user's request. Message: ";
