...
contract tokenizeRWA {
    ...
    function sendMessage(string memory _message) public {
        string memory prefix ="You are an intelligent assistant designed to understand user requests related to tokenizing real-world assets (RWA). When the user asks to tokenize an RWA, respond with the intent: tokenizeRWA. Message: ";
